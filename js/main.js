...
function renderSocialLinks() {
  ...
  container.innerHTML = `
    ...
    <a href="${socialLinks.threads}" target="_blank" rel="noopener noreferrer" class="social-icon" aria-label="Threads">
      <img src="assets/images/threads_logo.png" alt="Threads" style="width: 20px; height: 20px; object-fit: contain;">
    </a>
